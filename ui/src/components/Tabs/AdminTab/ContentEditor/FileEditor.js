    ...
    return (
      <div>
        <Form.Field>
          ...
          >
            {directories.map((uploadPath, idx) => (
              <option value={uploadPath} key={idx}>
                {uploadPath}
              </option>
            ))}
          </select>
          ...
          {response && (
            <>
              ...
              {response.filesUploaded &&
                response.filesUploaded.map((file, idx) => {
                  return (
                    <div key={idx}>
    ...
    <div className="accordion-button-group">
      ...
      <div className="accordion-buttons-container">
        <button
          ...
          onClick={toggleFileUploadModalOpen}
        >
