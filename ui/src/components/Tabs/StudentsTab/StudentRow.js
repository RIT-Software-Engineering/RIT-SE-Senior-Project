...
export default function StudentRow(props) {
  ...
  if (!props.studentsTab) {
    ...
    if (
      ...
      props.projectsData[props.student.project] !== undefined
    ) {
      student_cells.push(
        <TableCell key={"student-project-" + props.student.project}>
          {props.projectsData[props.student.project || "noProject"].name}
        </TableCell>,
      );
    } else {
      student_cells.push(
