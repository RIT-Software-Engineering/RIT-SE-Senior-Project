...
export default function ProjectEditorModal(props) {
    ...
    const [initialState, setInitialState] = useState({
        ...
        background_info: decode(props.project.background_info) || "",
        project_description: decode(props.project.project_description) || "",
        project_scope: decode(props.project.project_scope) || "",
        project_challenges: decode(props.project.project_challenges) || "",
        constraints_assumptions: decode(props.project.constraints_assumptions) || "",
        sponsor_provided_resources: decode(props.project.sponsor_provided_resources) || "",
        project_search_keywords: decode(props.project.project_search_keywords) || "",
        sponsor_deliverables: decode(props.project.sponsor_deliverables) || "",
        proprietary_info: decode(props.project.proprietary_info) || "",
        ...
        synopsis: decode(props.project.synopsis) || "",
