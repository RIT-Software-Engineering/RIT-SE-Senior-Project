...
import {
    Button, TextArea, Checkbox, Divider, Dropdown,
    Form, Grid, Header, Icon,
    List, Modal, Popup, Rating, Segment, Message,
} from "semantic-ui-react";
import {
    QuestionFeedback, QuestionMoodRating, QuestionPeerFeedback, QuestionTable,
            ...
            <Segment key={index}>
                <Form>
                    ...
                    <Form.Field>
                        ...
                        <Dropdown
                            selection
                            options={Object.keys(QuestionSettings).map(
                                (key) => {
                                    return {
                                        key: key + index,
                            ...
                            value={question.type}
                            onChange={(e, data) =>
                                updateQuestion(index, "type", data.value)
                            }
                        />
                    </Form.Field>
                    ...
                    <Form.Field>
                        <label>
                            ...
                            <Button
                                ...
                                circular
                                icon={
                                    <Icon color="black" name={"plus"} fitted/>
                                }
                                compact
                                onClick={() => {
                            ...
                            <Button
                                ...
                                circular
                                icon={
                                    <Icon color="black" name={"minus"} fitted/>
                                }
                                compact
                                onClick={() => {
                                    const updatedQuestions =
                                        question.questions.slice(0, -1);
                                    updateQuestion(
                                        index,
                                        "questions",
                                        updatedQuestions,
                        ...
                        {question.questions.map((question_title, i) => {
                            const questionUsed = questionIsUsed(
                                question_title,
                                index,
                                i,
                            );
                            ...
                            <Grid.Column width={4}>
                                ...
                                <Form>
                                    ...
                                    <Form.Field>
                                        ...
                                        <Form.Checkbox
                                            checked={
                                                globalSettings.defaultRequired
                                            }
                                            onChange={(e, data) =>
                                    ...
                                    <Form.Field>
                                        ...
                                        <Message
                                            ...
                                            content={
                                                <p>
                                                    Questions with the same name will be considered the same
                                                    question.{" "}
                                                    <b> Only pair Textual and Numeric questions together{" "} </b>{" "}
