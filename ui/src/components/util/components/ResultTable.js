            ...
            <Table collapsing celled striped>
                <TableHeader>
                    <TableRow>
                        ...
                        {
                            hasSelfRating &&
                            <TableHeaderCell>Self Rating</TableHeaderCell>
                        }
                    </TableRow>
                </TableHeader>
                <TableBody>
                                    ...
                                    <TableCell>
                                        {
                                            ...
                                            <>
                                                ...
                                                />
                                                <span> ({props.OthersFeedbackAvg[category] ? roundDec(props.OthersFeedbackAvg[category], 2) : " N/A "})</span>
                                                <input
                                                    type="hidden"
                                        ...
                                        <TableCell>
                                            {
                                                ...
                                                <>
                                                    <Rating
                                                        ...
                                                        maxRating={props.maxRating}
                                                    />
                                                    <span> ({props.SelfFeedback.Ratings[category] ? roundDec(props.SelfFeedback.Ratings[category], 2) : " N/A "})</span>
                                                </>
                                            }
                                            <input
                                                type="hidden"
                                                        ...
                                                        <List>
                                                            {props.OthersFeedback.map((student, otherIndex) => (
                                                                <ListItem key={otherIndex}>
                                                                    ...
                                                                    <TextArea disabled
                                                                              value={student.Feedback[category] || "No Feedback Given"}/>
                                                                </ListItem>
                                                            ))}
                                                            {hasSelfRating && props.SelfFeedback.Feedback[category] !== undefined && (
                                                                <ListItem>
                                                                    <Label ribbon size='large'
                                                                           color='black'>{props.student}</Label>
                                                                    <Rating
                                                                        disabled
                                                                        defaultRating={props.SelfFeedback.Ratings[category]}
                                                                        maxRating={props.maxRating}
                                                                    />
                                                                    <TextArea disabled
                                                                              value={props.SelfFeedback.Feedback[category] || "No Feedback Given"}/>
                                                                </ListItem>
                                                            )}
                                                        </List>
                                                    </Card.Description>
