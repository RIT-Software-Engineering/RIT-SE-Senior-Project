        ...
        <div id="page">
            ...
            <div className="ui container grid">
                ...
                <Form id="proposalForm" className="ui form" onSubmit={(e) => {submitProposal(e)}} >
                    ...
                    <Form.Input label="If you will not be available during the standard senior project meeting time above, please give your timing constraints." name="sponsor_alternate_time" value={formData.sponsor_alternate_time || ""} onChange={(e)=>{setFormData(e)}} />
