...
function SponsorPage() {
    ...
    const questions = [{
            key: 0,
            title: "How will my organization benefit from sponsoring a Senior Project?",
            content: {content: 
                <ul>
            ...
            key: 1,
            title: "What is the size, scope and duration of these projects?",
            content: {content: 
                <ul>
            ...
            key: 2,
            title: "Who works on the project?",
            content: {content: 
                <ul>
            ...
            key: 3,
            title: "What process is followed over the course of the project?",
            content: {content: 
                <ul>
            ...
            key: 4,
            title: "What are my responsibilities and commitments as a sponsor?",
            content: {content: 
                <ul>
            ...
            key: 5,
            title: "How are proposals reviewed?",
            content: {content: 
                <ol>
