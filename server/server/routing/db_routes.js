...
const sponsorsRoutes = require("./db_routes_parts/sponsors_routes");
const actionsRoutes = require("./db_routes_parts/actions_routes");
const projectsRoutes = require("./db_routes_parts/projects_routes");
const archivesRoutes = require("./db_routes_parts/archives_routes");
const errorLogsRoutes = require("./db_routes_parts/error_logs_routes");
